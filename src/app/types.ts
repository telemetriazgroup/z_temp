...
export interface User {
  ...
  empresa: string;
  role: UserRole;
  /** `['all']` = todos los IMEI. Lista explícita de IMEI si no es superusuario con acceso global. */
  deviceAccess: string[];
  /** Acceso global y gestión de usuarios (CRUD). */
  superUser?: boolean;
  /** Etiquetas por IMEI (p. ej. cuenta IFF Perú). */
...
/** Sesión en cliente: sin contraseña en memoria. */
export type SessionUser = Omit<User, 'password'>;

// --- Tipos API TermoKing / túnel (resumen y dispositivos)
