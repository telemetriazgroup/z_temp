      ...
      <Card className="max-w-lg w-full border-amber-200 bg-amber-50/40 dark:bg-amber-950/20">
        ...
        <CardContent className="space-y-4 text-sm">
          <p className="text-muted-foreground leading-relaxed">
            Su cuenta aún no tiene dispositivos ni grupos de equipos vinculados.
            Por eso no puede ver listados, monitoreo ni alarmas de flota.
          </p>
          <p className="font-medium">
            Consulte con su administrador para que le asignen equipos en el módulo
            de Administración.
          </p>
